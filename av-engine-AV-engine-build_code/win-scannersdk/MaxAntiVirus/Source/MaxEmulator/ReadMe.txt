========================================================================
    STATIC LIBRARY : MaxEmulator Project Overview
========================================================================

AppWizard has created this MaxEmulator library project for you.

This file contains a summary of what you will find in each of the files that
make up your MaxEmulator application.
...
StdAfx.h, StdAfx.cpp
    ...
    named MaxEmulator.pch and a precompiled types file named StdAfx.obj.
...
project, including "resource.h", "MaxEmulator.rc" and a "MaxEmulator.h" that
