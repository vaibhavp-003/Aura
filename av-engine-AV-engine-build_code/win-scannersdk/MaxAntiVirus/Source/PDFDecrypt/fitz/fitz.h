...
int fz_my_CCITTFax_Decrypt(char *dst, long *dstLen, char *src, long srcLen);
int fz_my_DCT_Decrypt(char *dst, long *dstLen, char *src, long srcLen);
int fz_my_JBIG2_Decrypt(char *dst, long *dstLen, char *src, long srcLen);
//int fz_my_JPX_Decrypt(char *dst, long *dstLen, char *src, long srcLen);
