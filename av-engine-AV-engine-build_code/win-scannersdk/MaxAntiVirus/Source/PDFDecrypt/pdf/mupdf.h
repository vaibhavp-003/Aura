...
struct pdf_xref_entry_num_s
{
	unsigned long num;
	int	entry_num;
};

typedef struct pdf_xref_entry_num_s pdf_xref_entry_num;

pdf_xref_entry_num g_xref_entry_num[240000];

int GetNewObjNum(int nOriginal);
...
fz_error pdf_open_xref(pdf_xref **xrefp, const wchar_t *filename, char *password);
