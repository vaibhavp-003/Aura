...
NOTES				: Declaration of all the Intel CPU instruction oprands and related structures for disassembler
VERSION HISTORY		: 
=====================================================================================*/
#pragma once
//#ifndef MAINPROG
...
//#if (char)0xFF!=255
// Comment: CondZero: default char type set to unsigned!!
...
typedef struct	tagInstructions
{
	DWORD	dwInstLen ;
	char	szOpcode[TEXTLEN] ;
	char	szPnuemonics[TEXTLEN] ;
}INSTRUCTION_SET;
