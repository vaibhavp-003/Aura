...
ACC_COMPILE_TIME_ASSERT_HEADER(CHAR_MAX == 255) // -funsigned-char OR /J on MSVC
ACC_COMPILE_TIME_ASSERT_HEADER((char)(-1) > 0) // -funsigned-char OR /J on MSVC
...
//void do_one_file(const char *iname, char *oname, unsigned long, unsigned long, bool);
