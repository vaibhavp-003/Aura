...
CString CCommonFunctions::GetFileName(CString sSectionName, CString csVersionINI)
{
	...
	GetPrivateProfileString(sSectionName, _T("Filename"), _T(""), sFileaname.GetBuffer(MAX_PATH), MAX_PATH, csVersionINI);
...
#ifdef WIN64
	if((csSection != _T("DELTADETAILS")) && (csSection != _T("ADDITIONALDOWNLOAD")))
	{
