/*======================================================================================
   FILE				: ping.cpp
   ABSTRACT			: This file contains implementation of ping
   DOCUMENTS		: 
...
/*-------------------------------------------------------------------------------------
Function		: _CPING(contructor)
In Parameters	:
Out Parameters	:
Purpose			: intialise variables
Author			:
...
/*-------------------------------------------------------------------------------------
Function		: ~_CPING(destructor)
In Parameters	:
Out Parameters	:
Purpose			: deintialise variables
Author			:
Description		: deintialise variables, and winsock library cleanup
--------------------------------------------------------------------------------------*/
_CPING::~_CPING()
{
#ifdef CPING_USE_ICMP
...
In Parameters	:
Out Parameters	: BOOL
Purpose			: intialise winsock
Author			:
Description		: intialise winsock
--------------------------------------------------------------------------------------*/
#ifdef CPING_USE_WINSOCK2
...
In Parameters	:
Out Parameters	: BOOL
Purpose			: intialise winsock and icmp library
Author			:
Description		: intialise winsock and icmp library functions
--------------------------------------------------------------------------------------*/
#ifdef CPING_USE_ICMP
...
/*-------------------------------------------------------------------------------------
Function		: Ping2
In Parameters	: LPCTSTR,CPingReply&,UCHAR,DWORD,UCHAR
Out Parameters	: BOOL
Purpose			: ping using winsock
Author			:
Description		: ping using winsock functions
--------------------------------------------------------------------------------------*/
#ifdef CPING_USE_WINSOCK2
...
/*-------------------------------------------------------------------------------------
Function		: IsSocketReadible
In Parameters	: SOCKET,DWORD,BOOL&
Out Parameters	: BOOL
Purpose			: check if data waiting on the socket
Author			:
Description		: check if data waiting on the socket
--------------------------------------------------------------------------------------*/
...
In Parameters	: LPCTSTR,CPingReply&,UCHAR,DWORD,UCHAR
Out Parameters	: BOOL
Purpose			: ping an IP using ICMP
Author			:
Description		: ping an IP using ICMP functions
--------------------------------------------------------------------------------------*/
#ifdef CPING_USE_ICMP
...
In Parameters	: char*,int,sockaddr_in*
Out Parameters	: BOOL
Purpose			: check the response packet
Author			:
Description		: check the response packet
--------------------------------------------------------------------------------------*/
#ifdef CPING_USE_WINSOCK2
...
/*-------------------------------------------------------------------------------------
Function		: GenerateIPChecksum
In Parameters	: USHORT*, int
Out Parameters	: USHORT
Purpose			: generate an IP checksum based on a given data buffer
Author			:
...
In Parameters	: USHORT*, int
Out Parameters	: USHORT
Purpose			: Fill up the ICMP packet with defined values
Author			:
