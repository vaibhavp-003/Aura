/*=============================================================================
   FILE		           : PictureExLogo.h
   ABSTRACT		       : Picture displaying control with support for the following formats:
   ...
   NOTE			       : Header file of the CPictureExLogo class.
   VERSION HISTORY	   :
=============================================================================*/
#if !defined(AFX_PICTUREEXLOGO_H__0EFE5DE0_7B68_4DB7_8B34_5DC634948438__INCLUDED_)
#define AFX_PICTUREEXLOGO_H__0EFE5DE0_7B68_4DB7_8B34_5DC634948438__INCLUDED_
...
class CPictureExLogo : public CStatic
{
public:
...
#pragma pack()// turn byte alignment off
	...
	// i.e.Load(MAKEINTRESOURCE(IDR_MYPIC),_T("JPGTYPE"));
	BOOL Load(LPCTSTR szResourceName,LPCTSTR szResourceType);

	BOOL Load(HMODULE hinstDLL, LPCTSTR szResourceName,LPCTSTR szResourceType);
	BOOL ShowHundredPercent();
...
#endif // !defined(AFX_PICTUREEXLOGO_H__0EFE5DE0_7B68_4DB7_8B34_5DC634948438__INCLUDED_)
