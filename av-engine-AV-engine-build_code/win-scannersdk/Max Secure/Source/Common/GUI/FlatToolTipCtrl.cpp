...
/*-----------------------------------------------------------------------------
Function		: CToolTipCtrlEx(Constructor)
In Parameters	:
Out Parameters	:
Purpose		:This Function initialize the CToolTipCtrlEx class
Author		:
-----------------------------------------------------------------------------*/
...
CToolTipCtrlEx::CToolTipCtrlEx()
{
	...
	{
		AddLogEntry(_T("Exception caught in CToolTipCtrlEx::CToolTipCtrlEx"));
	}
}

/*-----------------------------------------------------------------------------
Function		: ~CToolTipCtrlEx (Destructor)
In Parameters	:
Out Parameters	:
Purpose		:This Function Destruct the CToolTipCtrlEx class.
Author		:
-----------------------------------------------------------------------------*/
CToolTipCtrlEx::~CToolTipCtrlEx()
{
...
void CToolTipCtrlEx::PreSubclassWindow()
{
	...
	{
		AddLogEntry(_T("Exception caught in CToolTipCtrlEx::PreSubclassWindow"));
	}
}
...
void CToolTipCtrlEx::OnPaint()
{
	...
	{
		AddLogEntry(_T("Exception caught in CToolTipCtrlEx::OnPaint"));
	}
}
...
BOOL CToolTipCtrlEx::OnEraseBkgnd(CDC* pDC)
{
	...
	{
		AddLogEntry(_T("Exception caught in CToolTipCtrlEx::OnEraseBkgnd"));
	}
	return FALSE;
}
