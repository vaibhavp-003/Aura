...
/*-------------------------------------------------------------------------------------
Function		: CxSkinButtonNew
In Parameters	: -
Out	Parameters	: -
Purpose			: constructor to initialize member variables
Author			:
--------------------------------------------------------------------------------------*/
CxSkinButtonNew::CxSkinButtonNew()
{
	try
	{
	...
	{
		//AddLogEntry(_T("Exception caught in CxSkinButtonNew::CxSkinButtonNew"));
	}
}
...
BEGIN_MESSAGE_MAP(CxSkinButtonNew, CButton)
	//{{AFX_MSG_MAP(CxSkinButtonNew)
	ON_WM_ERASEBKGND()
	ON_WM_LBUTTONDOWN()
	ON_WM_LBUTTONUP()
	//ON_WM_MOUSEMOVE()
	...
	ON_MESSAGE(WM_CXSHADE_RADIO1, OnRadioInfo)
...
Author			:
--------------------------------------------------------------------------------------*/
void CxSkinButtonNew::PreSubclassWindow()
{
	try
	{
	...
	{
		//AddLogEntry(_T("Exception caught in CxSkinButtonNew::PreSubclassWindow"));
	}
}
void CxSkinButtonNew::SetResourceHandle(HANDLE hResHandle, HWND hWnd)
{
...
Author		:
-----------------------------------------------------------------------------*/
BOOL CxSkinButtonNew::OnEraseBkgnd(CDC* pDC)
{
...
Author			:
--------------------------------------------------------------------------------------*/
void CxSkinButtonNew::DrawItem(LPDRAWITEMSTRUCT lpDrawItemStruct)
{
	try
	{
	...
	{
		//AddLogEntry(_T("Exception caught in CxSkinButtonNew::DrawItem"));
	}
}
...
Author			:
--------------------------------------------------------------------------------------*/
int CxSkinButtonNew::GetBitmapWidth (HBITMAP hBitmap)
{
	try
	{
...
Author			:
--------------------------------------------------------------------------------------*/
int CxSkinButtonNew::GetBitmapHeight (HBITMAP hBitmap)
{
	try
	{
		BITMAP bm; GetObject(hBitmap,sizeof(BITMAP),(PSTR)&bm);
	...
	{
		//AddLogEntry(_T("Exception caught in CxSkinButtonNew::GetBitmapHeight"));
	}
	return 0;
}
...
Author			:
--------------------------------------------------------------------------------------*/
void CxSkinButtonNew::DrawBitmap(CDC* dc, HBITMAP hbmp, RECT r, int DrawMode)
{
	...
	{
		//AddLogEntry(_T("Exception caught in CxSkinButtonNew::DrawBitmap"));
	}
}
...
Author			:
--------------------------------------------------------------------------------------*/
void CxSkinButtonNew::FillWithBitmap(CDC* dc, HBITMAP hbmp, RECT r)
{
	try
	{
		if(!hbmp)return;
	...
	{
		//AddLogEntry(_T("Exception caught in CxSkinButtonNew::FillWithBitmap"));
	}
}
...
Author			:
--------------------------------------------------------------------------------------*/
void CxSkinButtonNew::SetSkin(UINT normal,UINT down,UINT over,UINT disabled, UINT focus,UINT mask,
						   short drawmode, short border, short margin)
{
	...
	{
		//AddLogEntry(_T("Exception caught in CxSkinButtonNew::SetSkin"));
	}
}
/*-------------------------------------------------------------------------------------
Function		: SetSkin
...
Author			: Dipali Pawar
--------------------------------------------------------------------------------------*/
void CxSkinButtonNew::SetSkin(HMODULE hinstDLL, UINT normal,UINT down,UINT over,UINT disabled, UINT focus,UINT mask,
						   short drawmode, short border, short margin)
{
	try
	{
...
Author			: Dipali Pawar
--------------------------------------------------------------------------------------*/
void CxSkinButtonNew::SetSkin(LPCTSTR normal,LPCTSTR down,LPCTSTR over,LPCTSTR disabled, LPCTSTR focus,LPCTSTR mask,
						   short drawmode, short border, short margin)
{
	try
	{
...
Author			:
--------------------------------------------------------------------------------------*/
HRGN CxSkinButtonNew::CreateRgnFromBitmap(HBITMAP hBmp, COLORREF color)
{
	try
	{
		if(!hBmp)
	...
	{
		//AddLogEntry(_T("Exception caught in CxSkinButtonNew::CreateRgnFromBitmap"));
	}
...
Author			:
--------------------------------------------------------------------------------------*/
COLORREF CxSkinButtonNew::SetTextColor(COLORREF new_color)
{
	try
	{
	...
	{
		//AddLogEntry(_T("Exception caught in CxSkinButtonNew::SetTextColor"));
	}
	return m_TextColor;
}
...
Author			: Sandip Sanap
--------------------------------------------------------------------------------------*/
COLORREF CxSkinButtonNew::SetFocusTextColor(COLORREF new_color)
{
	try
	{
	...
	{
		//AddLogEntry(_T("Exception caught in CxSkinButtonNew::SetFocusTextColor"));
	}
...
Author			:
--------------------------------------------------------------------------------------*/
COLORREF CxSkinButtonNew::SetTextColorA(COLORREF normal_color,COLORREF down_color,COLORREF over_color)
{
	try
	{
		COLORREF tmp_color = m_TextColor;
	...
	{
		//AddLogEntry(_T("Exception caught in CxSkinButtonNew::SetTextColorA"));
	}
	return m_TextColor;
}
...
Author			:
--------------------------------------------------------------------------------------*/
void CxSkinButtonNew::SetToolTipText(CString s)
{
	try
	{
	...
	{
		//AddLogEntry(_T("Exception caught in CxSkinButtonNew::SetToolTipText"));
	}
}
...
Author			:
--------------------------------------------------------------------------------------*/
void CxSkinButtonNew::RelayEvent(UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	{
		//AddLogEntry(_T("Exception caught in CxSkinButtonNew::RelayEvent"));
	}
}
...
void CxSkinButtonNew::OnLButtonDblClk(UINT flags, CPoint point)
{
	try
	{
	...
	{
		//AddLogEntry(_T("Exception caught in CxSkinButtonNew::OnLButtonDblClk"));
	}
}
...
Author			:
--------------------------------------------------------------------------------------*/
void CxSkinButtonNew::OnLButtonDown(UINT nFlags, CPoint point)
{
	try
	{
	...
	{
		//AddLogEntry(_T("Exception caught in CxSkinButtonNew::OnLButtonDown"));
	}
}
...
Author			:
--------------------------------------------------------------------------------------*/
void CxSkinButtonNew::OnLButtonUp(UINT nFlags, CPoint point)
{
	try
	{
		if(m_Style)
	...
	{
		//AddLogEntry(_T("Exception caught in CxSkinButtonNew::OnLButtonUp"));
	}
}
...
Author			:
--------------------------------------------------------------------------------------*/
void CxSkinButtonNew::OnMouseMove(UINT nFlags, CPoint point)
{
	try
	{
		//TRACE("* %08X: Mouse\n", ::GetTickCount());
	...
	{
		//AddLogEntry(_T("Exception caught in CxSkinButtonNew::OnMouseMove"));
	}
}
...
LRESULT CxSkinButtonNew::OnMouseLeave(WPARAM, LPARAM)
{
	try
	{
		//ASSERT (m_tracking);
	...
	{
		//AddLogEntry(_T("Exception caught in CxSkinButtonNew::OnMouseLeave"));
	}
	return 0;
}
...
Author			:
--------------------------------------------------------------------------------------*/
void CxSkinButtonNew::OnKillFocus(CWnd *new_wnd)
{
	...
	{
		//AddLogEntry(_T("Exception caught in CxSkinButtonNew::OnKillFocus"));
	}
}
/*-------------------------------------------------------------------------------------
Function		: OnSetFocus
...
Author			: Sunil Apte
--------------------------------------------------------------------------------------*/
void CxSkinButtonNew::OnSetFocus(CWnd *new_wnd)
{
	...
	{
		//AddLogEntry(_T("Exception caught in CxSkinButtonNew::OnSetFocus"));
	}
}
...
Author			:
--------------------------------------------------------------------------------------*/
BOOL CxSkinButtonNew::OnClicked()
{
	try
	{
		if(::GetCapture() == m_hWnd)
	...
	{
		//AddLogEntry(_T("Exception caught in CxSkinButtonNew::OnClicked"));
	}
	return FALSE;
}
...
Author			:
--------------------------------------------------------------------------------------*/
LRESULT CxSkinButtonNew::OnRadioInfo(WPARAM wparam, LPARAM)
{
	try
	{
	...
	{
		//AddLogEntry(_T("Exception caught in CxSkinButtonNew::OnRadioInfo"));
	}
	return 0;
}

void CxSkinButtonNew::OnKeyDown(UINT nChar, UINT nRepCnt, UINT nFlags)
{
	try
	{
	...
	{
		//AddLogEntry(_T("Exception caught in CxSkinButtonNew::OnKeyDown"));
	}
}
...
Author			:
--------------------------------------------------------------------------------------*/
LRESULT CxSkinButtonNew::OnBMSetCheck(WPARAM wparam, LPARAM)
{
	try
	{
		m_Checked=wparam!=0;
			...
			if(m_Checked){ //uncheck the other radio buttons (in the same group)
				...
				if(hthis && hpwnd){				//consistency check
					for(;;){	//scan the buttons within the group
						...
						::PostMessage(hwnd2, WM_CXSHADE_RADIO1, 0, 0);
					}
				}
			}
			break;
	...
	{
		//AddLogEntry(_T("Exception caught in CxSkinButtonNew::OnBMSetCheck"));
	}
	return 0;
}
...
Author			:
--------------------------------------------------------------------------------------*/
LRESULT CxSkinButtonNew::OnBMGetCheck(WPARAM wparam, LPARAM)
{
...
Author			:
--------------------------------------------------------------------------------------*/
void CxSkinButtonNew::SetTextAlignment(DWORD dwAlignment, bool bBottom)
{
...
--------------------------------------------------------------------------------------*/
void CxSkinButtonNew::ShowMultilineText(bool bMultiline)
{
...
--------------------------------------------------------------------------------------*/
void CxSkinButtonNew::ShowToplineText(bool bTopline)
{
