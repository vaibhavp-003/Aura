...
/*-------------------------------------------------------------------------------------
Function		: CxSkinButtonGreen
In Parameters	: -
Out	Parameters	: -
Purpose			: constructor to initialize member variables
Author			:
--------------------------------------------------------------------------------------*/
CxSkinButtonGreen::CxSkinButtonGreen()
{
	try
	{
	...
	{
		//AddLogEntry(_T("Exception caught in CxSkinButtonGreen::CxSkinButtonGreen"));
	}
}
...
BEGIN_MESSAGE_MAP(CxSkinButtonGreen, CButton)
	//{{AFX_MSG_MAP(CxSkinButtonGreen)
	ON_WM_ERASEBKGND()
	ON_WM_LBUTTONDOWN()
	ON_WM_LBUTTONUP()
	ON_WM_MOUSEMOVE()
	...
	ON_MESSAGE(WM_CXSHADE_RADIO2, OnRadioInfo)
...
Author			:
--------------------------------------------------------------------------------------*/
void CxSkinButtonGreen::PreSubclassWindow()
{
	try
	{
	...
	{
		//AddLogEntry(_T("Exception caught in CxSkinButtonGreen::PreSubclassWindow"));
	}
}
void CxSkinButtonGreen::SetResourceHandle(HANDLE hResHandle, HWND hWnd)
{
...
Author		:
-----------------------------------------------------------------------------*/
BOOL CxSkinButtonGreen::OnEraseBkgnd(CDC* pDC)
{
...
Author			:
--------------------------------------------------------------------------------------*/
void CxSkinButtonGreen::DrawItem(LPDRAWITEMSTRUCT lpDrawItemStruct)
{
	try
	{
	...
	{
		//AddLogEntry(_T("Exception caught in CxSkinButtonGreen::DrawItem"));
	}
}
...
Author			:
--------------------------------------------------------------------------------------*/
int CxSkinButtonGreen::GetBitmapWidth (HBITMAP hBitmap)
{
	try
	{
...
Author			:
--------------------------------------------------------------------------------------*/
int CxSkinButtonGreen::GetBitmapHeight (HBITMAP hBitmap)
{
	try
	{
		BITMAP bm; GetObject(hBitmap,sizeof(BITMAP),(PSTR)&bm);
	...
	{
		//AddLogEntry(_T("Exception caught in CxSkinButtonGreen::GetBitmapHeight"));
	}
	return 0;
}
...
Author			:
--------------------------------------------------------------------------------------*/
void CxSkinButtonGreen::DrawBitmap(CDC* dc, HBITMAP hbmp, RECT r, int DrawMode)
{
	...
	{
		//AddLogEntry(_T("Exception caught in CxSkinButtonGreen::DrawBitmap"));
	}
}
...
Author			:
--------------------------------------------------------------------------------------*/
void CxSkinButtonGreen::FillWithBitmap(CDC* dc, HBITMAP hbmp, RECT r)
{
	try
	{
		if(!hbmp)return;
	...
	{
		//AddLogEntry(_T("Exception caught in CxSkinButtonGreen::FillWithBitmap"));
	}
}
...
Author			:
--------------------------------------------------------------------------------------*/
void CxSkinButtonGreen::SetSkin(UINT normal,UINT down,UINT over,UINT disabled, UINT focus,UINT mask,
						   short drawmode, short border, short margin)
{
	...
	{
		//AddLogEntry(_T("Exception caught in CxSkinButtonGreen::SetSkin"));
	}
}
/*-------------------------------------------------------------------------------------
Function		: SetSkin
...
Author			: Dipali Pawar
--------------------------------------------------------------------------------------*/
void CxSkinButtonGreen::SetSkin(HMODULE hinstDLL, UINT normal,UINT down,UINT over,UINT disabled, UINT focus,UINT mask,
						   short drawmode, short border, short margin)
{
	try
	{
...
Author			: Dipali Pawar
--------------------------------------------------------------------------------------*/
void CxSkinButtonGreen::SetSkin(LPCTSTR normal,LPCTSTR down,LPCTSTR over,LPCTSTR disabled, LPCTSTR focus,LPCTSTR mask,
						   short drawmode, short border, short margin)
{
	try
	{
...
Author			:
--------------------------------------------------------------------------------------*/
HRGN CxSkinButtonGreen::CreateRgnFromBitmap(HBITMAP hBmp, COLORREF color)
{
	try
	{
		if(!hBmp)
	...
	{
		//AddLogEntry(_T("Exception caught in CxSkinButtonGreen::CreateRgnFromBitmap"));
	}
...
Author			:
--------------------------------------------------------------------------------------*/
COLORREF CxSkinButtonGreen::SetTextColor(COLORREF new_color)
{
	try
	{
	...
	{
		//AddLogEntry(_T("Exception caught in CxSkinButtonGreen::SetTextColor"));
	}
	return m_TextColor;
}
...
Author			: Sandip Sanap
--------------------------------------------------------------------------------------*/
COLORREF CxSkinButtonGreen::SetFocusTextColor(COLORREF new_color)
{
	try
	{
	...
	{
		//AddLogEntry(_T("Exception caught in CxSkinButtonGreen::SetFocusTextColor"));
	}
...
Author			:
--------------------------------------------------------------------------------------*/
COLORREF CxSkinButtonGreen::SetTextColorA(COLORREF normal_color,COLORREF down_color,COLORREF over_color)
{
	try
	{
		COLORREF tmp_color = m_TextColor;
	...
	{
		//AddLogEntry(_T("Exception caught in CxSkinButtonGreen::SetTextColorA"));
	}
	return m_TextColor;
}
...
Author			:
--------------------------------------------------------------------------------------*/
void CxSkinButtonGreen::SetToolTipText(CString s)
{
	try
	{
	...
	{
		//AddLogEntry(_T("Exception caught in CxSkinButtonGreen::SetToolTipText"));
	}
}
...
Author			:
--------------------------------------------------------------------------------------*/
void CxSkinButtonGreen::RelayEvent(UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	{
		//AddLogEntry(_T("Exception caught in CxSkinButtonGreen::RelayEvent"));
	}
}
...
void CxSkinButtonGreen::OnLButtonDblClk(UINT flags, CPoint point)
{
	try
	{
	...
	{
		//AddLogEntry(_T("Exception caught in CxSkinButtonGreen::OnLButtonDblClk"));
	}
}
...
Author			:
--------------------------------------------------------------------------------------*/
void CxSkinButtonGreen::OnLButtonDown(UINT nFlags, CPoint point)
{
	try
	{
	...
	{
		//AddLogEntry(_T("Exception caught in CxSkinButtonGreen::OnLButtonDown"));
	}
}
...
Author			:
--------------------------------------------------------------------------------------*/
void CxSkinButtonGreen::OnLButtonUp(UINT nFlags, CPoint point)
{
	try
	{
		if(m_Style)
	...
	{
		//AddLogEntry(_T("Exception caught in CxSkinButtonGreen::OnLButtonUp"));
	}
}
...
Author			:
--------------------------------------------------------------------------------------*/
void CxSkinButtonGreen::OnMouseMove(UINT nFlags, CPoint point)
{
	try
	{
		//TRACE("* %08X: Mouse\n", ::GetTickCount());
	...
	{
		//AddLogEntry(_T("Exception caught in CxSkinButtonGreen::OnMouseMove"));
	}
}
...
LRESULT CxSkinButtonGreen::OnMouseLeave(WPARAM, LPARAM)
{
	try
	{
		//ASSERT (m_tracking);
	...
	{
		//AddLogEntry(_T("Exception caught in CxSkinButtonGreen::OnMouseLeave"));
	}
	return 0;
}
...
Author			:
--------------------------------------------------------------------------------------*/
void CxSkinButtonGreen::OnKillFocus(CWnd *new_wnd)
{
	...
	{
		//AddLogEntry(_T("Exception caught in CxSkinButtonGreen::OnKillFocus"));
	}
}
/*-------------------------------------------------------------------------------------
Function		: OnSetFocus
...
Author			: Sunil Apte
--------------------------------------------------------------------------------------*/
void CxSkinButtonGreen::OnSetFocus(CWnd *new_wnd)
{
	...
	{
		//AddLogEntry(_T("Exception caught in CxSkinButtonGreen::OnSetFocus"));
	}
}
...
Author			:
--------------------------------------------------------------------------------------*/
BOOL CxSkinButtonGreen::OnClicked()
{
	try
	{
		if(::GetCapture() == m_hWnd)
	...
	{
		//AddLogEntry(_T("Exception caught in CxSkinButtonGreen::OnClicked"));
	}
	return FALSE;
}
...
Author			:
--------------------------------------------------------------------------------------*/
LRESULT CxSkinButtonGreen::OnRadioInfo(WPARAM wparam, LPARAM)
{
	try
	{
	...
	{
		//AddLogEntry(_T("Exception caught in CxSkinButtonGreen::OnRadioInfo"));
	}
	return 0;
}

void CxSkinButtonGreen::OnKeyDown(UINT nChar, UINT nRepCnt, UINT nFlags)
{
	try
	{
	...
	{
		//AddLogEntry(_T("Exception caught in CxSkinButtonGreen::OnKeyDown"));
	}
}
...
Author			:
--------------------------------------------------------------------------------------*/
LRESULT CxSkinButtonGreen::OnBMSetCheck(WPARAM wparam, LPARAM)
{
	try
	{
		m_Checked=wparam!=0;
			...
			if(m_Checked){ //uncheck the other radio buttons (in the same group)
				...
				if(hthis && hpwnd){				//consistency check
					for(;;){	//scan the buttons within the group
						...
						::PostMessage(hwnd2, WM_CXSHADE_RADIO2, 0, 0);
					}
				}
			}
			break;
	...
	{
		//AddLogEntry(_T("Exception caught in CxSkinButtonGreen::OnBMSetCheck"));
	}
	return 0;
}
...
Author			:
--------------------------------------------------------------------------------------*/
LRESULT CxSkinButtonGreen::OnBMGetCheck(WPARAM wparam, LPARAM)
{
...
Author			:
--------------------------------------------------------------------------------------*/
void CxSkinButtonGreen::SetTextAlignment(DWORD dwAlignment, bool bBottom)
{
...
--------------------------------------------------------------------------------------*/
void CxSkinButtonGreen::ShowMultilineText(bool bMultiline)
{
...
--------------------------------------------------------------------------------------*/
void CxSkinButtonGreen::ShowToplineText(bool bTopline)
{
