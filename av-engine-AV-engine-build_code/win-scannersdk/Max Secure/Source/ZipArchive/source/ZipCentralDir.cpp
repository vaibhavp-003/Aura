/*=============================================================================
   FILE		           : ZipCentralDir.cpp
   ABSTRACT		       : implementation of the CZipCentralDir class.
   DOCUMENTS	       : 
   AUTHOR		       : 
   COMPANY		       : Aura 
   COPYRIGHT NOTICE    :
...
/*-------------------------------------------------------------------------------------
	Function       : CZipCentralDir
	Purpose		   : Constructor for class ZipCentralDir
	Author		   : 
-------------------------------------------------------------------------------------*/
...
/*-------------------------------------------------------------------------------------
	Function       : !CZipCentralDir
	Purpose		   : Constructor for class CZipCentralDir
	Author		   : 
-------------------------------------------------------------------------------------*/
CZipCentralDir::~CZipCentralDir()
{
...
/*-------------------------------------------------------------------------------------
	Function       : AddNewFile
	In Parameters  : CZipFileHeader & header
	Out Parameters : void
