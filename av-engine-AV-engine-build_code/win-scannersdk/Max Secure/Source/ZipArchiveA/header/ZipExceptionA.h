/*=============================================================================
   FILE		           : ZipExceptionA.h
   ABSTRACT		       :  interface for the CZipExceptionA class.
   DOCUMENTS	       : 
   AUTHOR		       : 
   COMPANY		       : Aura 
   COPYRIGHT NOTICE    :
...
#if !defined(AFX_ZIPEXCEPTIONA_H__E3546921_D728_11D3_B7C7_E77339672847__INCLUDED_)
#define AFX_ZIPEXCEPTIONA_H__E3546921_D728_11D3_B7C7_E77339672847__INCLUDED_
...
class CZipExceptionA : public CException  
{
public:
	DECLARE_DYNAMIC(CZipExceptionA)
	...
	CZipExceptionA(int iCause = generic, LPCTSTR lpszZipName = NULL);
	virtual ~CZipExceptionA();

};
void AfxThrowZipExceptionA(int iZipError = 1000, LPCTSTR lpszZipName = NULL);
#endif // !defined(AFX_ZIPEXCEPTIONA_H__E3546921_D728_11D3_B7C7_E77339672847__INCLUDED_)
