...
Source: ..\..\MaxSpywareDetector\Setup\Tools\Drivers\Win8\x86\*.*; DestDir: {tmp}; Flags: dontcopy

Source: ..\..\MaxSpywareDetector\Output\Win32\Release\Binaries\AuCoreScanner.dll; DestDir: {app}; Flags:  overwritereadonly ignoreversion replacesameversion
Source: ..\..\MaxSpywareDetector\Output\Win32\Release\Binaries\AuSecure.dll; DestDir: {app}; Flags: overwritereadonly ignoreversion replacesameversion
Source: ..\..\MaxSpywareDetector\Output\Win32\Release\Binaries\AuScanner.exe; DestDir: {app}; Flags: ignoreversion overwritereadonly replacesameversion
Source: ..\..\MaxSpywareDetector\Output\Win32\Release\Binaries\AuActiveProtection.dll; DestDir: {app}; Flags: overwritereadonly ignoreversion replacesameversion
Source: ..\..\MaxSpywareDetector\Output\Win32\Release\Binaries\AuActMon.exe; DestDir: {app}; Flags: ignoreversion overwritereadonly replacesameversion
Source: ..\..\MaxSpywareDetector\Output\Win32\Release\Binaries\AuSpecialSpyHandler.dll; DestDir: {app}; Flags: ignoreversion overwritereadonly replacesameversion
Source: ..\..\MaxAntiVirus\Output\Win32\Release\Binaries\AuAVRepair.dll; DestDir: {app}; Flags: overwritereadonly ignoreversion replacesameversion
Source: ..\..\MaxAntiVirus\Output\Win32\Release\Binaries\AuAVPMScan.dll; DestDir: {app}; Flags: overwritereadonly ignoreversion replacesameversion
Source: ..\..\MaxAntiVirus\Output\Win32\Release\Binaries\AuAVDBScan.dll; DestDir: {app}; Flags: overwritereadonly ignoreversion replacesameversion
Source: ..\..\MaxAntiVirus\Output\Win32\Release\Binaries\AuPDFDecrypt.dll; DestDir: {app}; Flags: overwritereadonly ignoreversion replacesameversion
Source: ..\..\MaxAntiVirus\Output\Win32\Release\Binaries\AuRansomPatternScan.dll; DestDir: {app}; Flags: overwritereadonly ignoreversion replacesameversion
Source: ..\..\Max Secure\Output\Win32\Release\Binaries\DisasmEngineDll.dll; DestDir: {app}; Flags: ignoreversion overwritereadonly replacesameversion
Source: ..\..\MaxAntiVirus\Output\Win32\Release\Binaries\AuMLHeurScan.dll; DestDir: {app}; Flags: overwritereadonly ignoreversion replacesameversion
Source: ..\..\MaxAntiVirus\Output\Win32\Release\Binaries\AuAVDBScanCrypt.dll; DestDir: {app}; Flags: overwritereadonly ignoreversion replacesameversion

;Unpacker
Source: ..\..\NIH\Output\Win32\Release\Binaries\AuUPXUnpacker.dll; DestDir: {app}; Flags: overwritereadonly ignoreversion replacesameversion
Source: ..\..\MaxSpywareDetector\Output\Win32\Release\Binaries\AuUnpacker.dll; DestDir: {app}; Flags: ignoreversion overwritereadonly replacesameversion
Source: ..\..\NIH\Win32\unrar\unrar.dll; DestDir: {app}; Flags: overwritereadonly ignoreversion replacesameversion
...
;ML
Source: ..\..\MaxSpywareDetector\Setup\Tools\MLcpp\x86\*; DestDir: {app}; Flags: overwritereadonly ignoreversion replacesameversion
...
;RandPatScan
Source: ..\..\MaxAntiVirus\Output\Win32\Release\Binaries\AuRandPattern.dll; DestDir: {app}; Flags: overwritereadonly ignoreversion replacesameversion
Source: ..\..\MaxSpywareDetector\Setup\Tools\Python32\SetupFiles\*; DestDir: {app}; Flags: ignoreversion replacesameversion overwritereadonly recursesubdirs
...
;ExtractionDll
Source: ..\..\Max Secure\Output\Win32\Release\Binaries\Au7zUnpacker.dll; DestDir: {app}; Flags: overwritereadonly ignoreversion replacesameversion
Source: ..\..\MaxSpywareDetector\Setup\Tools\7zip\x86\7z.dll; DestDir: {app}; Flags: ignoreversion replacesameversion overwritereadonly recursesubdirs

;YaraScanner
Source: ..\..\MaxSpywareDetector\Setup\Tools\Yara\x86\AuYrScanner.dll; DestDir: {app}; Flags: overwritereadonly ignoreversion replacesameversion
...
Source: ..\..\MaxSpywareDetector\Setup\UltraAV32\*; DestDir: {app}; Flags: ignoreversion overwritereadonly replacesameversion recursesubdirs
Source: ..\..\MaxSpywareDetector\Output\Win32\Release\Binaries\AuBKComDll.dll; DestDir: {app}; Flags: ignoreversion overwritereadonly replacesameversion
...
Source: ..\..\MaxSpywareDetector\Setup\Tools\WscFiles\x86\AuWatchDogService.exe; DestDir: {app}; Flags: ignoreversion overwritereadonly replacesameversion
Source: ..\..\MaxSpywareDetector\Setup\Tools\WscFiles\x86\AuUpdateMrg.dll; DestDir: {app}; Flags: ignoreversion overwritereadonly replacesameversion
Source: ..\..\MaxSpywareDetector\Setup\Tools\WscFiles\x86\AuWsRMsg.exe; DestDir: {app}; Flags: overwritereadonly ignoreversion replacesameversion
Source: ..\..\MaxSpywareDetector\Setup\Tools\PPLFiles\x86\AuPSrvOpt.dll; DestDir: {app}; Flags: overwritereadonly ignoreversion replacesameversion 
Source: ..\..\MaxSpywareDetector\Output\Win32\Release\Binaries\AuTray.exe; DestDir: {app}; Flags: ignoreversion overwritereadonly replacesameversion
Source: ..\..\MaxSpywareDetector\Output\Win32\Release\Binaries\AuLiveUpdate.exe; DestDir: {app}; Flags: ignoreversion overwritereadonly replacesameversion
Source: ..\..\MaxSpywareDetector\Output\Win32\Release\Binaries\AuLiveUpdateDLL.dll; DestDir: {app}; Flags: ignoreversion overwritereadonly replacesameversion
Source: ..\..\MaxSpywareDetector\Output\Win32\Release\Binaries\AuSrvOpt.exe; DestDir: {app}; Flags: ignoreversion overwritereadonly replacesameversion
Source: ..\..\MaxSpywareDetector\Output\Win32\Release\Binaries\AuShellExt.dll; DestDir: {app}; Flags: uninsrestartdelete ignoreversion overwritereadonly replacesameversion regserver noregerror
Source: ..\..\MaxSpywareDetector\Output\Win32\Release\Binaries\AuNotifications.exe; DestDir: {app}; Flags: ignoreversion overwritereadonly replacesameversion
...
Source: ..\..\MaxSpywareDetector\Output\Win32\Release\Binaries\AuUninstall.dll; DestDir: {app}; Flags: overwritereadonly ignoreversion replacesameversion
Source: ..\..\MaxSpywareDetector\Output\Win32\Release\Binaries\AuDBServer.exe; DestDir: {app}; Flags: ignoreversion overwritereadonly replacesameversion
...
Source: ..\..\MaxSpywareDetector\Output\Win32\Release\Binaries\AuDigiScan.dll; DestDir: {app}; Flags: ignoreversion replacesameversion overwritereadonly
...
Source: ..\..\NIH\Win32\DBGHELP\dbghelp.dll; DestDir: {app}; Flags: overwritereadonly ignoreversion replacesameversion
...
Source: ..\..\MaxSpywareDetector\Setup\Tools\WinNotification\x86\AuWinToastMgr.dll; DestDir: {app}; Flags: uninsrestartdelete overwritereadonly ignoreversion replacesameversion
...
;AMSI
Source: ..\..\MaxSpywareDetector\Setup\Tools\AMSI\x86\*.*; DestDir: {app}\AMSI; Flags: overwritereadonly ignoreversion replacesameversion
Source: ..\..\MaxSpywareDetector\Setup\Tools\AMSI\AMSI_Provider\x86\AuAMSIProvider.dll; DestDir: {app}\AMSI; Flags: uninsrestartdelete ignoreversion overwritereadonly replacesameversion regserver noregerror

;32bit Liveupdate UI only
Source: ..\..\MaxSpywareDetector\Setup\Tools\mfc140u.dll; DestDir: {app}; Flags: overwritereadonly ignoreversion replacesameversion

Source: ..\..\MaxSpywareDetector\Setup\Depends\Win32\FIC.db; DestDir: {app}; Flags: overwritereadonly ignoreversion replacesameversion
...
begin
	if CurPage = 10 then begin
		...
		bReturnVal:= DLLFunction(hWnd, MessageType, csDownloadUrl, false, csProdReg);
